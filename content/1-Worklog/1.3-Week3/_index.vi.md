...
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------- | -------------------------------------- |
| 1    | - Nghiên cứu về **High Availability & Scalability** <br> + Tìm hiểu mô hình triển khai **Multi-AZ** <br> + Cấu hình thử nghiệm **Auto Scaling Group** <br> + Hiểu vai trò của **Elastic Load Balancer (ELB)** trong việc phân phối lưu lượng                      | 13/10/2025   | 13/10/2025    | <https://aws.amazon.com/autoscaling/>  |
| 2    | - Tìm hiểu **Amazon RDS** và **Aurora** <br> + Tạo instance RDS ở chế độ **Multi-AZ** <br> + Thử nghiệm **read replica** và **failover** <br> + Học về cơ chế **Aurora cluster** và khả năng tự phục hồi                                                          | 14/10/2025   | 14/10/2025    | <https://aws.amazon.com/rds/>          |
| 3    | - Làm việc với **Amazon ElastiCache** <br> + So sánh hai engine **Redis** và **Memcached** <br> + Thực hành tạo cache cluster <br> + Giám sát hiệu suất qua **CloudWatch**                                                                                        | 15/10/2025   | 15/10/2025    | <https://aws.amazon.com/elasticache/>  |
